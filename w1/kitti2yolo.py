#
# Functions encode(), decode(), and toBbox() are taken from the COCO API's pycocotools/mask.py.
    ...
    for txt_file in os.listdir(instance_txt_folder):
        ...
        with open(txt_path, 'r') as f:
            for line in f:
                ...
                # Convert RLE masks to bbox (xmin, ymin, width, height)
                x, y, w, h = toBbox(rle_data)
...
if __name__ == "__main__":
    ...
    instance_txt_dir = '/ghome/c5mcv04/MCV-C5-2025-Team4/dataset/KITTI-MOTS/instances_txt'
